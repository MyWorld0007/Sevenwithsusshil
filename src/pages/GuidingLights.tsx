        ...
        {loading ? (
          ...
          <div className="flex flex-col gap-24">
            {partners.filter(p => p.status !== 'pause').map((partner, i) => (
              ...
              >
                <div className={`md:col-span-5 relative max-w-[320px] md:max-w-none mx-auto w-full min-w-0 ${i % 2 === 1 ? 'md:order-2' : ''}`}>
                ...
                <div className={`md:col-span-7 min-w-0 break-words ${i % 2 === 1 ? 'md:order-1' : ''}`}>
                  {partner.gratitude && (
                    <div 
